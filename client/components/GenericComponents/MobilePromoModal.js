  ...
  return (
    <div className="fixed inset-0 z-[99999999] md:hidden flex items-center justify-center bg-black/60 px-4">
      <div className="relative bg-white w-full max-w-sm mx-auto rounded-xl shadow-lg p-4 overflow-y-auto max-h-[100%]">
        ...
        {/* Main Heading */}
        <div className="bg-gray-900 text-white py-2 rounded mb-4 mt-2">
        ...
        <div className="grid grid-cols-2 gap-2 text-sm font-fira mb-4">
          {[
            ...
            <a
              key={i}
              href="tel:+1-(888) 370-1612"
              className="bg-gray-900 text-white py-2 rounded text-center hover:bg-gray-800 transition"
            >
              {text}
            </a>
          ))}
        ...
        <div className="bg-gray-900 text-white rounded-full px-5 py-3 flex flex-wrap items-center justify-center gap-3 mt-4 max-w-xs mx-auto">
          ...
          <div className="text-center">
            ...
            <span className="text-xl font-bold block">+1-(888) 370-1612</span>
          </div>
        </div>
      </div>
    </div>
