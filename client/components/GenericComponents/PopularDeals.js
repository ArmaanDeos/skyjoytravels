...
const PopularDeals = ({
  heading = "Cheap Flight Deals",
  subheading = "Book now and save on flights to the world’s most popular destinations.",
  gradientFrom = "#ebf4ff",
  gradientTo = "#ede9fe",
  buttonFrom = "#0a3965",
  buttonTo = "#ff6e03",
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto text-center mb-10">
        ...
        <p className="text-gray-600 text-lg mb-6">{subheading}</p>
        ...
        {topDestinations.map((dest, index) => (
          ...
          >
            ...
            <div className="flex justify-between items-center mt-4">
              ...
              <a
                href={`tel:${phone}`}
                className="text-sm px-6 py-2 font-semibold text-white rounded-full transition-all transform hover:scale-105 shadow-md"
                style={{
